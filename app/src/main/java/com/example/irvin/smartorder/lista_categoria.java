...
public class lista_categoria extends AppCompatActivity {
    ...
    public lista_categoria lista_categoria = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptador_categoria = new adaptador_categoria(lista_categoria,arrayList,resources);
    ...
    public void onItemClick(int mPosition){
        ...
        Toast.makeText(lista_categoria.this,categoria.getNombre(),Toast.LENGTH_SHORT).show();
